...
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
   ...
   3. Modificado el tsconfig.app.json ![Alt text]("assets/migration15.x.x/assets/migration15.x.x/image-3.png)
   4. Actualización de rxjs y zone.js ![Alt text](assets/migration15.x.x/image-6.png)
   5. Actualización de typescript ![Alt text](assets/migration15.x.x/image-7.png)
...
Después de ejecutar el comando, además de la actualización de las versiones de material, comprueba los siguientes cambios realizados:
  1. Modificada la versión de tslib.
      ![Alt text](assets/migration15.x.x/image-4.png)
  ...
  ![Alt text](assets/migration15.x.x/image-5.png)
...
Ejecuta el comando para migrar a Angular como indica la [guía](https://update.angular.io/?l=3&v=9.0-10.2).
  ...
  ```
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
1. Actualización de typescript ![Alt text](assets/migration15.x.x/image-8.png)
2. Eliminación de { static: false } en los ViewChild ![Alt text](assets/migration15.x.x/image-9.png)
3. Cambios en el tsconfig.json ![Alt text](assets/migration15.x.x/image-10.png)
...
Actualiza la versión de node a la 14.20.0 y recuerda modificar si existen las referencias a la version de node, por ejemplo en el package.json. ![Alt text](assets/migration15.x.x/image-11.png)
Asegúrate de que el repositorio esté limpio, con los cambios commiteados, stageados o subidos ante de ejecutar los comandos.
...
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
1. Modificado el objeto opt del app-routing.module ![](assets/migration15.x.x/image-12.png)
2. Eliminado extractCss del angular.json ![Alt text](assets/migration15.x.x/image-13.png)
...
Ejecuta el comando para migrar a Angular como indica la [guía](https://update.angular.io/?l=3&v=11.0-12.0).
 ...
 ```bash
  ...
  ```
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
1. Actualización de zone ![Alt text](assets/migration15.x.x/image-16.png)
2. Actualización de typescript ![Alt text](assets/migration15.x.x/image-17.png)
3. Actualización del enviroment.ts ![Alt text](assets/migration15.x.x/image-18.png)
4. Actualización del polyfills.ts ![Alt text](assets/migration15.x.x/image-19.png)
...
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
1. Eliminación de los entryComponents en el .module ![Alt text](assets/migration15.x.x/image-21.png)
2. Actualizado test.ts ![Alt text](assets/migration15.x.x/image-22.png)
3. Actualizado typescript ![](assets/migration15.x.x/image-23.png)
...
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
1. Modificado tsconfig.json ![Alt text](assets/migration15.x.x/image-24.png)
2. Modificado el tipo FormBuilder ![Alt text](assets/migration15.x.x/image-25.png)
3. Modificado tipo de FormControl ![Alt text](assets/migration15.x.x/image-26.png)
4. Modificado angular.json ![Alt text](assets/migration15.x.x/image-27.png)
...
Después de ejecutar el comando, además de la actualización de las versiones de angular, comprueba los siguientes cambios realizados:
1. Actualizado typescript ![Alt text](assets/migration15.x.x/image-28.png)
2. Actualizado app-routing-module ![Alt text](assets/migration15.x.x/image-29.png)
3. Actualizado test.ts ![Alt text](assets/migration15.x.x/image-30.png)
4. Actualizado tsconfig.json ![Alt text](assets/migration15.x.x/image-31.png)
...
![Alt text](assets/migration15.x.x/image-33.png)
...
![Alt text](assets/migration15.x.x/image-36.png)
...
![Alt text](assets/migration15.x.x/image-1.png)
...
![Alt text](assets/migration15.x.x/image-2.png)
...
![Alt text](assets/migration15.x.x/image-15.png)
