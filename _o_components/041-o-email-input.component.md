...
## Basic example
<img src="{{ base_path }}/docs/images/components/inputs/o-email-input.png" alt="o-email-input component">
...
```
You can see this and more examples of this component in the [OntimizeWeb playground](https://try.imatia.com/ontimizeweb/playground/main/inputs/email).
